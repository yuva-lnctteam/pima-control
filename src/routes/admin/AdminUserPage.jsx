            ...
            <div className="w-full relative">
              ...
              <div className="flex gap-4 mb-6 items-center">
                ...
                <h1 className="text-3xl font-extrabold">
                  ...
                  {user?.mName && capitalizeFirstLetter(user?.mName)}{" "}
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-3 border p-6 rounded-[5px]">
                  ...
                  <div className="flex justify-between md:flex-row flex-col md:gap-4">
                    ...
                    <span className=" text-[#434343] break-words">#{user?.userId}</span>
                  </div>
                  <div className="bg-[#e4e4e4] w-full h-[1px]"></div>
                  <div className="flex justify-between md:flex-row flex-col md:gap-4">
                    <span className="font-semibold">Email</span>
                    <span className=" text-[#434343] break-words">{user?.email}</span>
                  </div>
                  <div className="bg-[#e4e4e4] w-full h-[1px]"></div>
                  <div className="flex justify-between md:flex-row flex-col md:gap-4">
                    <span className="font-semibold">Mobile No.</span>
                    <span className=" text-[#434343] break-words">{user?.phone}</span>
                  </div>
                  <div className="bg-[#e4e4e4] w-full h-[1px]"></div>
                  <div className="flex justify-between md:flex-row flex-col md:gap-4">
                    <span className="font-semibold">Job Position</span>
                    <span className=" text-[#434343] break-words">{user?.jobPosition}</span>
                  </div>
                </div>
                <div className="flex flex-col gap-3 border p-6 rounded-[5px]">
                  <h1 className="text-2xl font-bold text-center mb-4">
